...
\begin{document}
    ...
    \section{Work Experience}
        ...
        \begin{highlights}
            \item Contributed to the mission by writing the Interface Control Document for 4 different subsystems following ECSS standards.% PDR ?
    ...
    \textbf{Languages:} French (Native Speaker), English (\href{}{C1 - IELTS})
